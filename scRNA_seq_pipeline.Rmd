...
**Result:** Significant (p < 0.001) indicating partial confounding

- NA19101: well-balanced (84/75/72 across replicates)
- NA19239: well-balanced (94/81/88 across replicates)  
- NA19098: imbalanced (90/2/84 - missing from replicate 2)

Chi-square test: p = 9.215e-14 (significant)

**Decision:** Proceed with fastMNN but validate that biological signal is preserved

## 4.3 Quantify Correction Quality

Calculate variance explained (R²) before and after correction to check whether fastMNN preserved biological signal 
...
**Interpretation:** Despite partial confounding, fastMNN successfully:
1. Removed technical batch effects
2. Preserved genuine biological differences between individuals
3. The remaining individual R² (0.233) represents true biological variation

**This validates that fastMNN is appropriate for this dataset.**
---
